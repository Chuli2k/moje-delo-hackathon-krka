...
namespace krka_naloga2.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        private readonly IPrijavaDataManager _prijavaDataManager;
        ...
        public RegisterModel(
            ...
            IPrijavaDataManager prijavaDataManager)
        {
            _userManager = userManager;
            _signInManager = signInManager;
            _logger = logger;
            _emailSender = emailSender;
            _prijavaDataManager = prijavaDataManager;
        }
        ...
        public IEnumerable<SelectListItem> Podjetja { get; set; } = new List<SelectListItem>() {
            new SelectListItem(){Value="1", Text="Podj1"},
            new SelectListItem(){Value="2", Text="Podj2"}
        };
